    ...
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: appBarOverview(
            context, "${AppLocalizations.of(context)!.costOverview}"),
        body: Stack(children: [
          Container(
                        ...
                        children: [
                                  ...
                                  BlocBuilder<OverviewBloc, OverviewState>(
                                    builder: (context, state) {
                                      return MonthlyExpense(
                                        title:
                                            "${AppLocalizations.of(context)!.salaryTotal}",
                                        svgPath:
                          ...
                          BlocBuilder<OverviewBloc, OverviewState>(
                            builder: (context, state) {
                              return ExpenseBox(
                                title:
                                    '${AppLocalizations.of(context)!.totalpay}',
                          ...
                          BlocBuilder<OverviewBloc, OverviewState>(
                            builder: (context, state) {
                              return ChartExpense(
                                  costData: state.costData, date: state.date);
                            },
                          ),
                          BlocBuilder<OverviewBloc, OverviewState>(
                            builder: (context, state) {
