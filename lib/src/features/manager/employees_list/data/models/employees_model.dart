...
List<EmployeesListModel> employeesListModelFromJson(String str) =>
    List<EmployeesListModel>.from(
        json.decode(str).map((x) => EmployeesListModel.fromJson(x)));

String employeesListModelToJson(List<EmployeesListModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class EmployeesListModel extends EmployeesListEntity {
  EmployeesListModel({
    ...
    required String? sectionName_EN,
