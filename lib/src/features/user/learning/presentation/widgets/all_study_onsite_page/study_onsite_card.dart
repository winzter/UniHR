...
import '../../pages/course_onsite_page.dart';

class StudyOnsiteCard extends StatelessWidget {
  const StudyOnsiteCard({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => CourseOnsitePage(),));
        },
        child: Card(
          elevation: 10,
