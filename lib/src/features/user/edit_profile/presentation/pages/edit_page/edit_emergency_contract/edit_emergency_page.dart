...
class EditEmergencyContractPage extends StatefulWidget {
  ...
  const EditEmergencyContractPage(
      {super.key,
      required this.title,
  ...
  @override
  State<EditEmergencyContractPage> createState() =>
      _EditEmergencyContractPageState();
}
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () {
                                    if (formKey.currentState!.validate()) {
                                      ...
                                      editUserProvider
                                          .sendEditEmergencyContractData(
                                              emergencyName,
                                              phoneNum,
                                              emergencyRelationship);
                                      userProvider.setEmergency(emergencyName,
                                          emergencyRelationship, phoneNum);
