...
class TimeLineEntity extends Equatable {
  ...
  final List<RequestCompensate>? requestCompensate;
  final bool? absent;
  final bool? isLate;
...
class CheckEntity extends Equatable {
  ...
  final dynamic gpsLocationsName;
...
class RequestCompensate {
  ...
  final dynamic managerLv1ReApproveDate;
  final dynamic managerLv1ReApprove;
  final dynamic managerLv2ApproveBy;
  final dynamic managerLv2ApproveDate;
  final dynamic managerLv2ReApproveDate;
  final dynamic managerLv2ReApprove;
  ...
  RequestCompensate({
    ...
    this.managerLv1ReApproveDate,
    this.managerLv1ReApprove,
    this.managerLv2ApproveBy,
    this.managerLv2ApproveDate,
    this.managerLv2ReApproveDate,
    this.managerLv2ReApprove,
    this.requestTimecol,
    this.createDate,
...
class AttendanceDisplay extends Equatable {
